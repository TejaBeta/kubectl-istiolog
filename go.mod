...
require (
	...
	istio.io/istio v0.0.0-20221230194330-a543b629f00c
	k8s.io/api v0.26.0
...
require (
	...
	istio.io/api v0.0.0-20221229195829-f0141fc155ed // indirect
	istio.io/client-go v1.12.0-alpha.5.0.20221229200230-5c7ac793b6ec // indirect
